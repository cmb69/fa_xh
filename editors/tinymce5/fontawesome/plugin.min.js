...
tinymce.PluginManager.add('fontawesome', function (editor, url) {
    ...
    var iconList = [];
    var iconListGroups = [];
    var meta = document.querySelector("meta[name=fontawesome_version]");
    var version = 4;
    ...
    if (meta) {
        version = parseInt(meta.content, 10) || 4;
    }
    resource.load("tinymce.plugins.fontawesome", url + '/icons' + version + '.js').then(init, function () {
        console.log("error");
    });
    ...
    editor.on('init', function () {
        ...
        switch (version) {
            ...
            case 5:
            case 6:
                stylesheet = 'plugins/fa/css/v' + version + '/all.min.css';
                break;
        }
