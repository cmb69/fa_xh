...
tinymce.PluginManager.add('fontawesome', function (editor, url) {
    ...
    function showDialog() {
        ...
        panelHtml += '<p class="mce-fontawesome-search-noresults" style="display: none;">' +
            translate('No icons matched your search') + '.</p>' + '</div>';
        ...
        function toggleItem() {
            ...
            if (!open) {
                ...
                accordionItemContent.ontransitionend = function () {
                    var panel = document.querySelector(".mce-fontawesome-panel");
                    var bottom = accordionItemContent.offsetTop + accordionItemContent.offsetHeight;
                    if (bottom > panel.scrollHeight) {
                        panel.scrollTop += bottom - panel.scrollHeight;
                    }
                    accordionItemContent.ontransitionend = null;
                };
            }
        }
        ...
        searchContainer.innerHTML = '<input type="search" placeholder="' + translate('English search term') + '"><div class="mce-fontawesome-search-container-clear"><span class="fa fa-times-circle"></span></div>';
