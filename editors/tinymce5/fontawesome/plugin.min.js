                ...
                for (var x = 0; x < width; x++) {
                    if (iconGroup[y * width + x]) {
                        ...
                        for (var i = 0; i < classes.length; i++) {
                            klass = classes[i];
                            gridHtml += '<div class="mce-icon-cell js-mce-fontawesome-insert" title="' + name + '" data-id="' + id + '" data-class="' + klass + '"' + (group === 'spinnerIcons' ? ' data-spin="true"' : '') + '>';
                            gridHtml += '<span class="' + klass + ' fa-' + id + (group === 'spinnerIcons' ? ' fa-spin' : '') + '"></span>';
                            gridHtml += '</div>';
                        }
                    }
                }
