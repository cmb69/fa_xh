...
$plugin_tx['fa']['cf_fontawesome_version']="The Font Awesome version to use. The editor plugins are not yet compatible with Font Awesome 5/6, unless the shim is enabled.";
$plugin_tx['fa']['cf_fontawesome_shim']="Improved backward compatibility when using Font Awesome 5/6.";
